...
describe('Scope', function(){
  ...
  describe('digest loop', function () {
    describe('digest', function(){
      ...
      it('triggers chained watchers in the same digest', function () {
        ...
        // if these watchers where in the opposite order,
        // the test would pass regardless of chaining.
        scope.$watch(
      ...
      it('gives up on the watcher after 10 iterations', function () {
        scope.counterA = 0;
        scope.counterB = 0;
      ...
      it('runs any new watches before ending the digest loop', function () {
  ...
  describe('inheritance', function () {
    ...
    describe('digesting from $apply and $evalAsync', function () {
      ...
      it('schedules a digst from root on $evalAsync', function (done) {
        var child2 = child.$new();
        parent.aValue = 'abc';
        parent.counter = 0;
        parent.$watch(
  ...
  describe('$watchCollection', function () {
    ...
    it('notives an item replaced in a NodeList object', function () {
    ...
    it('does not consider any object with ah length propesty an array', function () {
      scope.obj = {length: 42, otherkey: 'arst'};
      scope.counter = 0;
